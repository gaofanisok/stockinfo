...
public class UserController {
    ...
    public String getUserByid(HttpServletRequest request) {
        try {
            ...
            String user = userManager.getUserByid(openId);
            if (StringUtil.isNotEmpty(user)) {
...
//    }
     ...
     * @return
     */
    @PostMapping(value = "upUserTx")
    public String upUserTx(HttpServletRequest request) {
        String tx = RequestUtil.getString(request, "tx");
        String openId = request.getHeader("openId");
        String user = userManager.upUserTx(tx, openId);
        try {
            if (StringUtil.isNotEmpty(user)) {
